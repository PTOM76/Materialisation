...
public class MaterialisationCreateOverrideNameScreen extends Screen {
    ...
    public void render(DrawContext context, int mouseX, int mouseY, float delta) {
        ...
        context.drawTextWithShadow(textRenderer, Text.translatable("config.text.materialisation.override_json_file_saved"), width / 4, 74, -6250336);
        context.drawTextWithShadow(textRenderer, Text.translatable("config.text.materialisation.priority"), width / 4, 104, -6250336);
